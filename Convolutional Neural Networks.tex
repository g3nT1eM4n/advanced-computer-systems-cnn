...
\begin{figure}[H]
  \includegraphics[width=\linewidth]{Images/(SVMs.png}
  \caption{SVMs.}
  \label{fig:SVMs}
\end{figure}
...
\begin{figure}[H]
  \includegraphics[width=\linewidth]{Images/(R-CNN.png}
  \caption{R-CNN.}
  \label{fig:R-CNN}
\end{figure}
...
\begin{figure}[H]
  \includegraphics[width=\linewidth]{Images/(Fast R-CNN.png}
  \caption{Fast R-CNN.}
...
\begin{figure}[H]
  \includegraphics[width=\linewidth]{Images/(RPN.png}
  \caption{RPN.}
  \label{fig:RPN}
\end{figure}
...
\begin{figure}[H]
  \includegraphics[width=\linewidth]{Images/(Faster R-CNN.png}
  \caption{Faster R-CNN.}
  \label{fig:Faster R-CNN}
\end{figure}

It has the same structer as Fast R-CNN, with the expection that it uses RPN instead of Traditional Methods
...
\begin{figure}[H]
  \includegraphics[width=\linewidth]{Images/(Suppression.png}
  \caption{Suppression.}
